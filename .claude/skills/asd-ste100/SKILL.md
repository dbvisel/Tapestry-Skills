...
skill_discovery_hints:
  - keywords: ["ASD-STE100", "Simplified Technical English", "controlled language", "plain language rewrite"]
  - keywords: ["PR comment style", "code comment style", "reduce verbosity", "disambiguate agent text"]
last_verified: 2026-09-03
---

**Vendored from an external repo** ([danyuchn/asd-ste100-skill](https://github.com/danyuchn/asd-ste100-skill),
MIT-licensed) — not authored in or verified against this project. Referenced by
`tapestry-pr-conventions` for code-comment and PR-reply writing style. The frontmatter
fields above this note were added on import to satisfy this repo's `tools/verify-skills.py`
structural checks; the skill content below (starting at "# Simplified Technical English")
is the real upstream content, unmodified.
